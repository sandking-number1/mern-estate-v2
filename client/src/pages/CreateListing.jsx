  ...
  return (
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        ...
        <input type="text" placeholder="Name" className='border p-3 rounded-lg' id="name" maxLength="62" minLemgth="10" required/>
        ...
        <div className="flex flex-col flex-1 gap-4">
            ...
            <div className="flex gap-4">
                ...
                <button className="p-3 text-green-700 border border-green-700
                 rounded uppercase hover:shadow-lg disabled:opacity-80 hover:bg-gray-400 ">Upload</button>
            </div>
        <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 diabled:opacity-88'>Create Listing</button>
        </div>
      </form>
    </main>
  )
